...
if ( ! function_exists( 'mu_country_modal_enqueue' ) ) {
    function mu_country_modal_enqueue() {
        ...
        wp_enqueue_style( 'mu-country-modal', $theme_uri . '/css/components/country-modal.css', [ 'generate-style-css' ], $theme_version );
        wp_enqueue_script( 'mu-country-modal-js', $theme_uri . '/js/country-modal.js', [], $theme_version, true );
    }
    add_action( 'wp_enqueue_scripts', 'mu_country_modal_enqueue', 1000 );
}
